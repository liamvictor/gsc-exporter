...
def generate_reports(site_evals, file_suffix, last_month_str, output_dir_str, format_arg):
    ...
    if format_arg in ['all', 'html']:
        ...
        with open(html_path, 'w') as f:
            ...
            f.write("      background-color: #0b0f19;\n")
            f.write("      color: #f3f4f6;\n")
            f.write("      padding-top: 2rem;\n")
            f.write("      padding-bottom: 4rem;\n")
            f.write("    }\n")
            f.write("    .card {\n")
            f.write("      background-color: #111827;\n")
            f.write("      border: 1px solid #1f2937;\n")
            f.write("      border-radius: 12px;\n")
            f.write("      box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);\n")
            f.write("      margin-bottom: 2rem;\n")
            f.write("    }\n")
            f.write("    .card-header {\n")
            f.write("      background-color: #1f2937;\n")
            f.write("      border-bottom: 1px solid #374151;\n")
            ...
            f.write("    }\n")
            f.write("    .table th {\n")
            f.write("      border-bottom: 2px solid #374151;\n")
            f.write("      background-color: #111827;\n")
            f.write("      color: #9ca3af;\n")
            f.write("    }\n")
            f.write("    .table td {\n")
            f.write("      border-bottom: 1px solid #1f2937;\n")
            f.write("      background-color: #111827;\n")
            f.write("      vertical-align: middle;\n")
            f.write("    }\n")
            f.write("    .table-striped>tbody>tr:nth-of-type(odd)>td {\n")
            f.write("      background-color: #161e2e;\n")
            f.write("    }\n")
            f.write("    .badge-ok {\n")
            f.write("      background-color: rgba(16, 185, 129, 0.15);\n")
            f.write("      color: #34d399;\n")
            f.write("      border: 1px solid rgba(16, 185, 129, 0.3);\n")
            f.write("    }\n")
            f.write("    .badge-partial {\n")
            f.write("      background-color: rgba(245, 158, 11, 0.15);\n")
            f.write("      color: #fbbf24;\n")
            f.write("      border: 1px solid rgba(245, 158, 11, 0.3);\n")
            f.write("    }\n")
            f.write("    .badge-missing {\n")
            f.write("      background-color: rgba(239, 68, 68, 0.15);\n")
            f.write("      color: #f87171;\n")
            f.write("      border: 1px solid rgba(239, 68, 68, 0.3);\n")
            f.write("    }\n")
            f.write("    .btn-copy {\n")
            f.write("      background-color: #374151;\n")
            f.write("      border: 1px solid #4b5563;\n")
            f.write("      color: #d1d5db;\n")
            f.write("      font-size: 0.8rem;\n")
            f.write("      padding: 0.25rem 0.5rem;\n")
            f.write("      transition: all 0.2s ease;\n")
            f.write("    }\n")
            f.write("    .btn-copy:hover {\n")
            f.write("      background-color: #4b5563;\n")
            ...
            f.write("      box-shadow: 0 0 0 0.25rem rgba(59, 130, 246, 0.25);\n")
            f.write("    }\n")
            f.write("    a {\n")
            f.write("      color: #60a5fa;\n")
            f.write("      text-decoration: none;\n")
            f.write("    }\n")
            f.write("    a:hover {\n")
            f.write("      color: #93c5fd;\n")
            ...
            for site, data in site_evals.items():
                ...
                for m in data['months']:
                    ...
                    if status != 'OK':
                        ...
                        f.write(f"                  <code class='text-light'>{cmd}</code>\n")
